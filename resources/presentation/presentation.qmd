...
![](../resources/figures/punktwolke.png)
...
![](../resources/figures/rheinhausen_points_z.jpeg){width=800}
![](../resources/figures/rheinhausen_points_z_sideview.jpeg){width=800}
...
![](../resources/figures/rheinhausen_points_numberofreturns.jpeg){width=800}
![](../resources/figures/rheinhausen_points_numberofreturns_sideview.jpeg){width=800}
...
![](../resources/figures/rheinhausen_points_returnnumber.jpeg){width=800}
![](../resources/figures/rheinhausen_points_returnnumber_sideview.jpeg){width=800}

## Attribute -Intensity {transition="fade" transition-speed="fast"}

![](../resources/figures/rheinhausen_points_intensity.jpeg){width=800}
![](../resources/figures/rheinhausen_points_intensity_sideview.jpeg){width=800}
...
::: {.r-stack}
![](../resources/figures/rheinhausen_dtm.jpeg){width=1000}

![](../resources/figures/rheinhausen_dsm.jpeg){.fragment width=1000 fragment-index=1}

![](../resources/figures/rheinhausen_chm.jpeg){.fragment width=1000 fragment-index=2}
:::
...
::: {.r-stack}
![](../resources/figures/rheinhausen_dtm_hillshade2.jpeg){.fragment width=1200 fragment-index=0}

![](../resources/figures/rheinhausen_low-vegetation.jpeg){.fragment width=1200 fragment-index=1}

![](../resources/figures/rheinhausen_intensity-lower.jpeg){.fragment width=1200 fragment-index=2}

![](../resources/figures/rheinhausen_intensity-upper.jpeg){.fragment width=1200 fragment-index=3}

![](../resources/figures/rheinhausen_ortho.jpeg){.fragment width=1200 fragment-index=4}
...
![](../resources/figures/baum_schillerwiesen_chm.jpeg){.fragment .fade-out}

![](../resources/figures/baum_schillerwiesen.gif){.fragment}
...
![](../resources/figures/plot_raw.png)

![](../resources/figures/plot_linear_horizontal.png){.fragment}

![](../resources/figures/plot_linear_vertical.png){.fragment}

![](../resources/figures/hochsitz.gif){.fragment}
...
![](../resources/figures/versuchsflaeche_goettingen_topview.jpg)

![](../resources/figures/versuchsflaeche_goettingen_sideview.jpg)
...
::: {.r-stack}
![](../resources/figures/chm_2017.jpeg){.fragment width=1200 fragment-index=0}

![](../resources/figures/chm_2020.jpeg){.fragment width=1200 fragment-index=1}

![](../resources/figures/chm_2017-chm_2020.jpeg){.fragment width=1200 fragment-index=2}

![](../resources/figures/chm_2017-chm_2020_detail.jpeg){.fragment width=1200 fragment-index=3}
:::
...
## Bestandesinventur
::: {#fig-nrt-inventory}
![](../resources/figures/nrt_inventory.jpeg)
...
::: {.r-stack}
![](../resources/figures/dtm_2017_hillshade.jpeg){width=1200}

![](../resources/figures/dtm_2020_hillshade.jpeg){.fragment width=1200 fragment-index=1}

![](../resources/figures/dtm_2017-dtm_2020_detail_hillshade.jpeg){.fragment width=1200 fragment-index=2}
:::
...
::: {#fig-friederike}
![](../resources/figures/friederike.png)
...
::: {#fig-tls-sideview}
![](../resources/figures/versuchsflaeche-tls.jpg)
